...
typedef struct
{
    ...
    // Flag qui appelle la machine d'état principale
    bool mainTimerHasOcurred;
    // Flag qui effectue la prichaine étape de l'animation
    bool shiftTimerHasOcurred;

} APP_DATA;

// Compteur du nombre de characters d'un nom
extern uint8_t countCar;

// Nombre de Matrix max sur le quel on peut afficher
extern uint8_t maxMatrix;
