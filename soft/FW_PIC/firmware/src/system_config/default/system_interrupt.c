...
// Date 		: 12.06.2022
// Descrition   : Fichier du code des interruptions et ISR
/******************************************************************************/
...
#include "system/common/sys_common.h"   // Library de communicaiton system
...
// Main program cadence 10ms
void __ISR(_TIMER_1_VECTOR, ipl3AUTO) IntHandlerDrvTmrInstance0(void)
{
    // Appel de la fonction de Callback de commande de la machine d'état pricipale
    MainTimer_Callback();
    
    // Clear du flag d'interuption du Timer1
